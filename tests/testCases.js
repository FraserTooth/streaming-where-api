module.exports = {
  ...
  expectedTestUserAHash:
    "$2y$12$Z92RVZlg729bWa6xXyLdcO0XHJbLsPHkCVSKhMgjBk2oiRFGvWJBa",
  ...
  expectedTestUserBHash:
    "$2y$12$jaDggZFxROVxe/zVmW0EbOw9F6DzMtycerBdwmNPd8la9ZiWuKT8S",
  ...
  seedStreamingServices: [
    { name: "Netflix", base_url: "https://netflix" },

    { name: "Amazon Prime Video", base_url: "https://amazon" }
  ],
  ...
  seedMedia: [
...

    {
      ...
      tmdb_api_url:
        "https://www.themoviedb.org/tv/48891-brooklyn-nine-nine/season/1",
      type: "season"
    },
